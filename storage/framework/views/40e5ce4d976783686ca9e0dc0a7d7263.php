...
<body>
    <div class="login-box">
        ...
        <?php if(session('status')): ?>
            <div class="alert alert-ok"><i data-lucide="check-circle"></i> <?php echo e(session('status')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
...
<?php /**PATH /Users/maksymzabavchuk/Desktop/certicars/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>