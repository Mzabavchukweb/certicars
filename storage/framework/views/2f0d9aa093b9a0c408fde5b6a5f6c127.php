...
<head>
    ...
    <?php if (! empty(trim($__env->yieldContent('meta_title_full')))): ?>
    <title><?php echo $__env->yieldContent('meta_title_full'); ?></title>
    <?php else: ?>
    <title><?php echo $__env->yieldContent('title','Certyfikowane samochody używane'); ?> — CertiCars</title>
    <?php endif; ?>
    <meta name="description" content="<?php echo $__env->yieldContent('description','CertiCars — platforma komisowa certyfikowanych samochodów używanych z pełną inspekcją techniczną.'); ?>">
    <meta name="theme-color" content="#0066ff">
    <meta property="og:type" content="<?php echo $__env->yieldContent('og_type','website'); ?>">
    <meta property="og:site_name" content="CertiCars">
    <meta property="og:locale" content="pl_PL">
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title','CertiCars — certyfikowane samochody używane'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description','Platforma komisowa certyfikowanych samochodów używanych z pełną inspekcją techniczną.'); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og_image', asset('img/og-default.jpg')); ?>">
    <meta name="twitter:card" content="summary_large_image">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('favicon.svg')); ?>">
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('favicon.ico')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('favicon.svg')); ?>">
    <?php if (! empty(trim($__env->yieldContent('extra_head')))): ?><?php echo $__env->yieldContent('extra_head'); ?><?php endif; ?>
...
<body>
        ...
        <div class="topbar-in">
            <div class="topbar-left">
                <a href="tel:+48123456789">
                    ...
                    <span class="tb-strong">+48 123 456 789</span>
                </a>
    ...
    <header class="header" id="siteHeader">
        <div class="header-in">
            <a href="<?php echo e(route('home')); ?>" class="header-logo" aria-label="CertiCars — strona główna">
            ...
            <nav class="header-nav" aria-label="Główna nawigacja">
                <a href="<?php echo e(route('home')); ?>" class="nav-link <?php echo e(request()->routeIs('home')?'active':''); ?>">Strona główna</a>
                <a href="<?php echo e(route('catalog')); ?>" class="nav-link <?php echo e(request()->routeIs('catalog*')?'active':''); ?>">Oferta</a>
                <a href="<?php echo e(route('about')); ?>" class="nav-link <?php echo e(request()->routeIs('about')?'active':''); ?>">O nas</a>
                <a href="<?php echo e(route('contact')); ?>" class="nav-link <?php echo e(request()->routeIs('contact')?'active':''); ?>">Kontakt</a>
                <a href="<?php echo e(route('favorites')); ?>" class="nav-link <?php echo e(request()->routeIs('favorites')?'active':''); ?>" id="navFavLink" style="display:flex;align-items:center;gap:6px">
                    Obserwowane
            ...
            <a href="<?php echo e(route('catalog')); ?>" class="header-cta"><i data-lucide="search" aria-hidden="true"></i> Znajdź auto</a>
        ...
        <nav class="nav-mobile" id="navMobile" aria-label="Menu mobilne">
            ...
            <a href="<?php echo e(route('catalog')); ?>" class="nav-link nav-mobile-cta">
    ...
    <a href="tel:+48123456789" class="float-call" aria-label="Zadzwoń +48 123 456 789">
    ...
    <footer class="footer" id="kontakt">
        <div class="footer-in">
            ...
            <div class="footer-brand">
                <a href="<?php echo e(route('home')); ?>" class="footer-logo" aria-label="CertiCars">
                    <svg class="footer-logo-badge" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z" fill="#0066ff"/>
                        <path d="M9 12l2 2 4-4" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span class="footer-logo-wordmark">Certi<span>Cars</span></span>
                    <span class="footer-logo-sep" aria-hidden="true"></span>
            ...
            <div>
                <h3>Kontakt</h3>
                <div class="fcc">
                    <a href="tel:+48123456789" class="fcc-card">
                        <div class="fcc-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.6 21 3 13.4 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1z"/></svg>
                        </div>
                        <div class="fcc-body"><strong>Zadzwoń</strong><span>+48 123 456 789</span></div>
                    </a>
                    <a href="mailto:kontakt@certicars.pl" class="fcc-card">
                        <div class="fcc-icon">
                        ...
                        <div class="fcc-body"><strong>Email</strong><span>kontakt@certicars.pl</span></div>
                    </a>
                    <div class="fcc-addr">
                        <div class="fcc-icon">
                        ...
                        <div class="fcc-body"><strong>Nasz salon</strong><span>ul. Przykładowa 15<br>00-001 Warszawa</span></div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="fsoc">
                    <a href="#" class="fsoc-card fsoc-fb">
                        <div class="fsoc-logo-fb">
                        ...
                        <div class="fsoc-txt"><strong>Facebook</strong><span>Odwiedź nasz profil →</span></div>
                    </a>
                    <a href="#" class="fsoc-card fsoc-ig">
                        <div class="fsoc-logo-ig">
            ...
            <div>
                ...
                <ul class="footer-hours">
                    <li>Pon–Pt <strong>9:00–18:00</strong></li>
                    <li>Sob <strong>10:00–14:00</strong></li>
                    <li>Ndz <em>— zamknięte</em></li>
                </ul>
            </div>
...
<?php /**PATH /Users/maksymzabavchuk/Desktop/certicars/resources/views/layouts/public.blade.php ENDPATH**/ ?>