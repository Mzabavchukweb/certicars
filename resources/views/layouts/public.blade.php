...
<body>
    ...
    <header class="header" id="siteHeader">
        <div class="header-in">
            ...
            <nav class="header-nav" aria-label="Główna nawigacja">
                ...
                <a href="{{ route('home') }}#certicheck" class="nav-link">CertiCheck</a>
        ...
        <nav class="nav-mobile" id="navMobile" aria-label="Menu mobilne">
            ...
            <a href="{{ route('home') }}#certicheck" class="nav-link">
    ...
    @media(max-width:720px){
        ...
        .lcard-actions{min-width:0;width:100%;flex-direction:row;align-items:center;justify-content:space-between;gap:12px;padding-top:10px;border-top:1px solid #f1f5f9}
        .lcard-price{font-size:20px}
