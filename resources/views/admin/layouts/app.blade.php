...
<div class="ad-wrap">
    <aside class="ad-side" id="adSide">
        ...
        <nav class="ad-nav">
            ...
            <a href="{{ route('admin.mail.index') }}" class="{{ request()->routeIs('admin.mail.*')?'active':'' }}"><i data-lucide="mail-check"></i> Poczta</a>
...
const CMDK_PAGES=[
    ...
    {t:'Poczta',s:'Diagnostyka wysyłki i odbioru',icon:'mail-check',url:'{{ route('admin.mail.index') }}'},
