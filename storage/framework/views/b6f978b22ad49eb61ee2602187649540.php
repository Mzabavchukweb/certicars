...
<div class="container" style="padding-top:16px">
    ...
    <div class="cs-head">
        <div style="min-width:0">
            ...
            ?>
            <?php if(count($metaParts)): ?>
            <div class="cs-meta">
                <?php $__currentLoopData = $metaParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span><?php echo e($part); ?></span><?php if($i < count($metaParts) - 1): ?><span class="sep">·</span><?php endif; ?>
    ...
    <?php if($car->mileage || $car->first_registration || $car->fuel_type || $car->transmission || $car->power_hp || $car->category): ?>
    <div class="cs-keyfacts">
        <?php if($car->mileage): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></svg><strong><?php echo e(number_format((float) $car->mileage,0,'',' ')); ?> km</strong></div><?php endif; ?>
        <?php if($car->first_registration): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg><strong><?php echo e($car->first_registration); ?></strong></div><?php endif; ?>
        <?php if($car->fuel_type): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="15" y1="22" y2="22"/><path d="M14 22V4a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v18"/></svg><strong><?php echo e($car->fuel_type); ?></strong></div><?php endif; ?>
        <?php if($car->transmission): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22V8"/><path d="m5 12-3 3 3 3"/><path d="m19 12 3 3-3 3"/><path d="M2 15h20"/><path d="m5 5-3 3 3 3"/><path d="M2 8h10"/></svg><strong><?php echo e($car->transmission); ?></strong></div><?php endif; ?>
        <?php if($car->power_hp): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/></svg><strong><?php echo e($car->power_hp); ?> KM</strong></div><?php endif; ?>
        <?php if($car->category): ?><div class="cs-keyfact"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg><strong><?php echo e($car->category); ?></strong></div><?php endif; ?>
    </div>
    <?php endif; ?>
    ...
    <div class="cs-grid">
        ...
        <div class="cs-gallery-tabs">
            ...
            <button type="button" class="cs-gallery-tab <?php echo e($car->pano360Image ? '' : 'disabled'); ?>" data-gallery-filter="pano360" onclick="csFilterGallery(this,'pano360')">
            ...
            <button type="button" class="cs-gallery-tab <?php echo e($car->exteriorPano360Image ? '' : 'disabled'); ?>" data-gallery-filter="pano360ext" onclick="csFilterGallery(this,'pano360ext')">
        ...
        <div class="cs-gallery">
            <div class="cs-gallery-stage">
                ...
                <?php if($car->pano360Image): ?>
                <div class="cs-gallery-main cs-pano360" id="csPano360" style="background:#000">
                    <div id="csPanoramaContainer" style="width:100%;height:100%;background:#000" data-pano-src="<?php echo e($car->pano360Image->url); ?>"></div>
                ...
                <?php if($car->exteriorPano360Image): ?>
                <div class="cs-gallery-main cs-pano360ext" id="csPano360ext" style="background:#000">
                    <div id="csPanoramaExtContainer" style="width:100%;height:100%;background:#000" data-pano-src="<?php echo e($car->exteriorPano360Image->url); ?>"></div>
                    <div style="position:absolute;top:14px;left:50%;transform:translateX(-50%);background:rgba(10,10,10,.78);color:#fff;font-size:12px;padding:7px 14px;border-radius:50px;display:flex;align-items:center;gap:8px;backdrop-filter:blur(6px);font-weight:600">
        ...
        <div class="cs-sidebar">
            ...
            <div class="cs-sidebar-card">
                ...
                <div class="cs-sidebar-summary">
                    <?php if($car->first_registration): ?><div class="cs-sidebar-summary-row"><span class="lbl">Rejestracja</span><span class="val"><?php echo e($car->first_registration); ?></span></div><?php endif; ?>
                    <?php if($car->mileage): ?><div class="cs-sidebar-summary-row"><span class="lbl">Przebieg</span><span class="val"><?php echo e(number_format((float) $car->mileage,0,'',' ')); ?> km</span></div><?php endif; ?>
                    ...
                    <?php if($car->engine_capacity): ?><div class="cs-sidebar-summary-row"><span class="lbl">Seria</span><span class="val"><?php echo e(number_format((float) $car->engine_capacity,0,'',' ')); ?> cm³</span></div><?php endif; ?>
                    <?php if($car->body_type ?? $car->category): ?><div class="cs-sidebar-summary-row"><span class="lbl">Nadwozie</span><span class="val"><?php echo e($car->body_type ?? $car->category); ?></span></div><?php endif; ?>
                    <?php if($car->co2_emission): ?><div class="cs-sidebar-summary-row"><span class="lbl">CCL</span><span class="val"><?php echo e($car->co2_emission); ?> g/km</span></div><?php endif; ?>
                ...
                <div class="cs-price-actions">
                    ...
                    <div style="display:flex;gap:8px">
                        <button type="button" class="cs-btn-secondary" id="csSidebarFav" data-id="<?php echo e($car->id); ?>" onclick="toggleFav(event,<?php echo e($car->id); ?>);csSidebarFavUpdate()" style="flex:1">
                        ...
                        <a href="<?php echo e(route('car.pdf', $car->slug)); ?>" class="cs-sidebar-certi" title="Pobierz raport CertiCheck PDF">
        ...
        <div class="cs-data-section">
            ...
            <div class="cs-data-body open" style="padding:0">
                <div class="cs-sub-bd open">
                    ...
                    <?php if($car->doors): ?><div class="cs-data-row"><span class="lbl">Drzwi</span><span class="val"><?php echo e($car->doors); ?><?php if($car->seats): ?>/<?php echo e($car->seats); ?><?php endif; ?></span></div><?php endif; ?>
                    <?php if($car->seats && !$car->doors): ?><div class="cs-data-row"><span class="lbl">Siedzenia</span><span class="val"><?php echo e($car->seats); ?></span></div><?php endif; ?>
                    <?php if($car->weight): ?><div class="cs-data-row"><span class="lbl">Masa</span><span class="val"><?php echo e(number_format((float) $car->weight, 0, '', ' ')); ?> kg</span></div><?php endif; ?>
        ...
        <div class="cs-data-section">
            ...
            <div class="cs-data-body open" style="padding:0">
                <div class="cs-sub-bd open">
                    ...
                    <?php if($car->mileage): ?><div class="cs-data-row"><span class="lbl">Przebieg</span><span class="val"><?php echo e(number_format((float) $car->mileage, 0, '', ' ')); ?> km</span></div><?php endif; ?>
        ...
        <div class="cs-data-section">
            ...
            <div class="cs-data-body open" style="padding:0">
                <div class="cs-sub-bd open">
                    ...
                    <?php if($car->engine_capacity): ?><div class="cs-data-row"><span class="lbl">Pojemność silnika</span><span class="val"><?php echo e(number_format((float) $car->engine_capacity, 0, '', ' ')); ?> ccm</span></div><?php endif; ?>
    ...
    <div class="cs-col-right">
        ...
        <div class="cs-data-section">
            ...
            <div class="cs-data-body open" style="padding:0">
                <div class="cs-sub-bd open">
                    ...
                    <?php if($car->last_service_mileage): ?><div class="cs-data-row"><span class="lbl">Przebieg przy serwisie</span><span class="val"><?php echo e(number_format((float) $car->last_service_mileage,0,'',' ')); ?> km</span></div><?php endif; ?>
        ...
        <div class="cs-data-section">
            ...
            <div class="cs-data-body open" style="padding:0">
                <div class="cs-sub-bd open">
                    <?php if($car->fuel_consumption): ?><div class="cs-data-row"><span class="lbl">Zużycie paliwa</span><span class="val"><?php echo e($car->fuel_consumption); ?> l/100km</span></div><?php endif; ?>
                    <?php if($car->co2_emission): ?><div class="cs-data-row"><span class="lbl">Emisja CO₂</span><span class="val"><?php echo e($car->co2_emission); ?> g/km</span></div><?php endif; ?>
        ...
        <div class="cs-data-body open">
            ...
            <div class="cs-paint-grid">
                ...
                <div class="cs-paint-item">
                    <div class="cs-paint-label"><?php echo e($panelLabel); ?></div>
                    <div class="cs-paint-value <?php echo e($val > 200 ? 'cs-paint-danger' : ($val > 160 ? 'cs-paint-warn' : '')); ?>"><?php echo e($val); ?> <span style="font-size:12px;font-weight:500;color:var(--text-3)">µm</span></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
                    ...
                    <?php if($car->technical_conditions && count($car->technical_conditions)): ?>
                        ...
                        <div class="cs-data-row">
                            <span class="lbl" style="font-weight:600;color:#1a1a1a;display:flex;align-items:center;gap:8px">
                                ...
                                <?php echo e($compLabel); ?>

                            </span>
                            <span class="val" style="color:#374151;font-weight:500"><?php echo e($st); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                ...
                <div class="cs-data-block">
                    ...
                    <?php if($car->engine_video_url || $car->engine_video_path): ?>
                        ...
                        <div style="position:relative;border-radius:12px;overflow:hidden;background:#000;aspect-ratio:16/9">
                            ...
                            <?php else: ?>
                                <div style="padding:20px;color:#fff">Film: <a href="<?php echo e($vidUrl); ?>" target="_blank" style="color:#fff;text-decoration:underline">link</a></div>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
    ...
    <?php if($car->pano360Image || $car->exteriorPano360Image): ?>
    <div class="cs-data-section">
        <div class="cs-data-header open" onclick="this.classList.toggle('open');this.nextElementSibling.classList.toggle('open')">
        ...
        <div class="cs-data-body open">
            ...
            <div class="cs-pano360-grid" style="grid-template-columns:<?php echo e(($car->pano360Image && $car->exteriorPano360Image) ? '1fr 1fr' : '1fr'); ?>">
                <?php if($car->pano360Image): ?>
                <div>
                    ...
                    <div class="cs-pano360-embed" style="position:relative;aspect-ratio:16/9;background:#000;border-radius:12px;overflow:hidden">
                        <div id="csPano360Section" data-pano-src="<?php echo e($car->pano360Image->url); ?>" style="width:100%;height:100%"></div>
                    </div>
                </div>
                <?php endif; ?>
                <?php if($car->exteriorPano360Image): ?>
                <div>
                    ...
                    <div class="cs-pano360-embed" style="position:relative;aspect-ratio:16/9;background:#000;border-radius:12px;overflow:hidden">
                        <div id="csPano360ExtSection" data-pano-src="<?php echo e($car->exteriorPano360Image->url); ?>" style="width:100%;height:100%"></div>
                    </div>
                </div>
                <?php endif; ?>
            </div>
    ...
    <div style="margin-top:20px;padding:24px 24px 0;border-top:1px solid var(--border-l);max-width:1200px;margin-left:auto;margin-right:auto">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
            ...
            <a href="<?php echo e(route('catalog')); ?>" style="font-size:13px;font-weight:700;color:var(--blue);display:inline-flex;align-items:center;gap:5px;text-decoration:none">
                Pokaż wszystkie
        ...
        <div class="cs-related-grid">
            <?php $__currentLoopData = $relatedCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relCar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('catalog.show', $relCar)); ?>" class="vcard">
                <div class="vcard-img">
                    <?php if($relCar->primaryImage): ?>
                        <img src="<?php echo e($relCar->primaryImage->url); ?>" alt="<?php echo e($relCar->primaryImage->alt); ?>" loading="lazy">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <?php if($relCar->is_featured): ?><div class="vcard-badge">Wyróżnione</div><?php endif; ?>
                ...
                <div class="vcard-body">
                    <div class="vcard-title"><?php echo e($relCar->title); ?></div>
                    <div class="vcard-specs">
                        <?php if($relCar->mileage): ?><span><?php echo e(number_format((float) $relCar->mileage,0,'',' ')); ?> km</span><?php endif; ?>
                        <?php if($relCar->fuel_type): ?><span><?php echo e($relCar->fuel_type); ?></span><?php endif; ?>
                        <?php if($relCar->first_registration): ?><span><?php echo e($relCar->first_registration); ?></span><?php endif; ?>
                        <?php if($relCar->power_hp): ?><span><?php echo e($relCar->power_hp); ?> KM</span><?php endif; ?>
                    </div>
                    <div class="vcard-bottom">
                        <div class="vcard-price"><?php echo e($relCar->formatted_price); ?></div>
...
<div class="cs-calc-float" id="csCalcFloat">
    ...
    <div class="cs-calc" id="csCalc">
        ...
        <div class="cs-calc-body">
            <?php $carPrice = (float) ($car->price ?? 0); ?>
