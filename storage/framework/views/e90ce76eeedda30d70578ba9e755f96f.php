<?php $__env->startSection('title','O nas'); ?>
<?php $__env->startSection('description','Poznaj historię CertiCars — platformy certyfikowanych samochodów używanych. Transparentność, jakość i pełna dokumentacja każdego pojazdu.'); ?>
...
<section class="about-cta">
    <div class="about-section-in">
        ...
        <div class="about-cta-btns">
            <a href="<?php echo e(route('catalog')); ?>" class="cta-btn-white">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="cta-btn-outline">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/maksymzabavchuk/Desktop/certicars/resources/views/pages/about.blade.php ENDPATH**/ ?>